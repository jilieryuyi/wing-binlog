                ...
                <div class="x_content">
                  <div style="text-align: right;">
                    ...
                    <a class="page-item" href="logs.php?page=1<?php  if ($session_id)
                      echo "&session_id=".$session_id; ?>">First page</a>
                    <a class="page-item">The <?php echo $page; ?>/<?php echo $all_page; ?> page</a>
                    <span class="page-item">
                      The<input title="jump to page" style="width: 36px; text-align: center; height: 17px;" type="text" value="<?php echo $page; ?>"/>page
                      <a class="jump-to" onclick="jumpTo(this)">jump</a>
                    </span>
                    <a class="page-item" href="logs.php?page=<?php echo $all_page; if ($session_id)
                      echo "&session_id=".$session_id;?>">Last page</a>
                    <a class="page-item" href="logs.php?page=<?php echo $next_page;if ($session_id)
                      echo "&session_id=".$session_id; ?>">Next page</a>
                  </div>
