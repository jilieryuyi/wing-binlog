        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2 style="width: 120px; float: left;">进程列表</h2> <small style="float: left; margin-top: 8px;">
                    <?php $sysinfo = \Seals\Library\Worker::getSystemInfo(); ?>
                    总内存<?php echo $sysinfo["memory_total"] ?>M, 已使用<?php echo $sysinfo["memory_usage"]; ?>M, <?php echo bcdiv($sysinfo["memory_usage"]*100/$sysinfo["memory_total"],1,2); ?>%, Cpu已使用<?php echo $sysinfo["cpu_usage"]; ?>%
                  </small>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
