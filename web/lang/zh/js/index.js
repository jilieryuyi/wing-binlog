            ...
            '<tr>'+
                '<td class="edit" colspan="8">'+
                    '<a ' +
                        ...
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'href="node.config.php?group_id='+group_id+'&session_id='+session_id+'" >配置</a>'+
                    '<a ' +
                    ...
                    '<a ' +
                        ...
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'href="report.php?group_id='+group_id+'&session_id='+session_id+'" >报表</a>'+

                            '<a ' +
                            'class="btn btn-success"  '+
                            'data-group-id="'+group_id+'" '+
                            'data-session-id="'+session_id+'" '+
                            'href="node.info.php?session_id='+session_id+'" >服务器详情</a>'+
                            '<a ' +
                            'class="btn btn-success"  '+
                            'data-group-id="'+group_id+'" '+
                            'data-session-id="'+session_id+'" '+
                            'href="logs.php?session_id='+session_id+'" >日志</a>'+
        ...
        '<li class="group group-'+group_id+'">'+
            '<div class="item">'+
                ...
                '<span class="group-edit edit col-md-8">' +
                    ...
                    'php seals server:restart"  '+
                    'data-group-id="'+group_id+'" '+
        'onclick="groupRestart(this)" >更新</a>'+
