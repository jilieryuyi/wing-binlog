                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">用户姓名 <span class="required">*</span>
                        </label>
...
<!--                      </div>-->
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button style="float: left;" type="button" onclick="updateUser(this)" class="btn btn-success">保存更新</button>
                          <a style="float: left;margin-top: 15px;margin-left: 12px;" href="role.add.php">添加角色</a>
