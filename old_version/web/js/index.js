            ...
            '<tr>'+
                '<td class="edit" colspan="8">'+
                    '<a ' +
                        ...
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'href="node.config.php?group_id='+group_id+'&session_id='+session_id+'" >__LANG(Configure)</a>'+
                    '<a ' +
                    ...
                    '<a ' +
                        ...
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'href="report.php?group_id='+group_id+'&session_id='+session_id+'" >__LANG(Report)</a>'+

                            '<a ' +
                            'class="btn btn-success"  '+
                            'data-group-id="'+group_id+'" '+
                            'data-session-id="'+session_id+'" '+
                            'href="node.info.php?session_id='+session_id+'" >__LANG(Server Detail)</a>'+
                            '<a ' +
                            'class="btn btn-success"  '+
                            'data-group-id="'+group_id+'" '+
                            'data-session-id="'+session_id+'" '+
                            'href="logs.php?session_id='+session_id+'" >__LANG(Logs)</a>'+


                            '<a class="btn bg-red"  '+
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'onclick="nodeRestart(this)" >__LANG(Restart)</a>'+
                    ...
                    '<a class="btn btn-success update-btn" ' +
                        ...
                        'data-group-id="'+group_id+'" '+
                        'data-session-id="'+session_id+'" '+
                        'onclick="nodeUpdate(this)" >__LANG(Update)';
                    if (node.update == 1)
                     html +='<label>1</label>';
    ...
    var html   =
        '<li class="group group-'+group_id+'">'+
            '<div class="item">'+
                ...
                '<span class="group-edit edit col-md-8">' +
                    ...
                    'php seals server:restart"  '+
                    'data-group-id="'+group_id+'" '+
        'onclick="groupRestart(this)" >__LANG(Update)</a>'+
        ...
        // 'onclick="openGroupGenerallog(this,0)" >Disable General Log</a>'+
            ...
            '<table class="nodes-list table table-striped"><thead><tr>';
                if (length > 0) {
                html +=
                    '<th class="node-id">__LANG(Node)</th>' +
                    '<th class="online-status">__LANG(Status)</th>'+
                    '<th class="is-leader">__LANG(Leader)</th>' +
                    // '<th class="generallog">General Log</th>' +
                    '<th class="last-pos">__LANG(Last Read)</th>' +
                    '<th class="version">__LANG(Version)</th>' +
                    '<th class="start-time">__LANG(Start Time)</th>' +
                    '<th class="time-len">__LANG(Running Time)</th>';// +
                }
